...
The [baseline system](https://claritychallenge.org/clarity_CEC1_doc/docs/cec1_baseline) includes sample data (rooms, scenes, listeners, and listeners assigned to specific scenes) and walks you through accessing and utilizing the data. The environment is one with stationary noise and simple indoor scenes.

## CEC2 Challenge

The [CEC2 challenge](https://claritychallenge.org/docs/cec2/cec2_intro) is about improve speech understanding in noise when there is a single target speaker in background noise (multiple sources) in a simulated living room scenario using a range of signal-to-noise ratios and with head movement.
